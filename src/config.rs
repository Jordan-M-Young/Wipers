...
#[cfg(test)]
mod tests {
    use super::{load_toml, LockConfig, OpenAiConfig, TomlConfig};
    ...
    fn test_load_good_toml() {
        ...
        let lock_config = LockConfig { lockfiles: vec![] };
    ...
    #[test]
    #[should_panic(
        expected = "called `Result::unwrap()` on an `Err` value: Error { inner: Error { inner: TomlError { message: \"missing field `key`\", original: Some(\"[openai]\\norg_id = \\\"\\\"\\n\\n[lock]\\nlockfiles = []\"), keys: [\"openai\"], span: Some(0..20) } } }"
    )]
    ...
    #[test]
    #[should_panic(
        expected = "called `Result::unwrap()` on an `Err` value: Error { inner: Error { inner: TomlError { message: \"missing field `org_id`\", original: Some(\"[openai]\\nkey = \\\"\\\"\\n\\n[lock]\\nlockfiles = []\"), keys: [\"openai\"], span: Some(0..17) } } }"
    )]
    ...
    #[test]
    #[should_panic(
        expected = "called `Result::unwrap()` on an `Err` value: Error { inner: Error { inner: TomlError { message: \"missing field `lockfiles`\", original: Some(\"[openai]\\nkey = \\\"\\\"\\norg_id = \\\"\\\"\\n\\n[lock]\\n\"), keys: [\"lock\"], span: Some(31..37) } } }"
    )]
